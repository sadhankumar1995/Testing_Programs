...
public class LoginPage {
	...
	@Before(order = 2)
	public void startDbConnection2()										// Hooks concept: we r using Before and After concept.
	{
		System.out.println("-----------Db connection is started_2-----------");
	}
	
	@After(order = 2)
	public void closeDbConnection2()										// Hooks concept: we r using Before and After concept.
	{
		System.out.println("-----------Db connection is closed_2-----------");
	}
	
	@Before(order = 1)
	public void startDbConnection1()										// Hooks concept: we r using Before and After concept.
	{
		System.out.println("-----------Db connection is started_1-----------");
	}
	
	@After(order = 1)
	public void closeDbConnection1()										// Hooks concept: we r using Before and After concept.
	{
		System.out.println("-----------Db connection is closed_1-----------");
	}
